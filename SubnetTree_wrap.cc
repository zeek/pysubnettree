...
fail:
  SWIG_SetErrorMsg(PyExc_NotImplementedError,"Wrong number of arguments for overloaded function 'new_SubnetTree'.\n"
...
fail:
  SWIG_SetErrorMsg(PyExc_NotImplementedError,"Wrong number of arguments for overloaded function 'SubnetTree_insert'.\n"
    "  Possible C/C++ prototypes are:\n"
    "    insert(SubnetTree *,char const *,PyObject *)\n"
    "    insert(SubnetTree *,char const *)\n"
    "    insert(SubnetTree *,unsigned long,unsigned short,PyObject *)\n"
    "    insert(SubnetTree *,unsigned long,unsigned short)\n");
  return NULL;
}
...
fail:
  SWIG_SetErrorMsg(PyExc_NotImplementedError,"Wrong number of arguments for overloaded function 'SubnetTree_remove'.\n"
    "  Possible C/C++ prototypes are:\n"
    "    remove(SubnetTree *,char const *)\n"
    "    remove(SubnetTree *,unsigned long,unsigned short)\n");
  return NULL;
}
...
fail:
  SWIG_SetErrorMsg(PyExc_NotImplementedError,"Wrong number of arguments for overloaded function 'SubnetTree_lookup'.\n"
    "  Possible C/C++ prototypes are:\n"
    "    lookup(SubnetTree const *,char const *,int)\n"
    "    lookup(SubnetTree const *,unsigned long)\n");
  return NULL;
}


SWIGINTERN PyObject *_wrap_SubnetTree_binary_lookup_mode(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  SubnetTree *arg1 = (SubnetTree *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  ...
  if (!PyArg_ParseTuple(args,(char *)"O:SubnetTree_binary_lookup_mode",&obj0)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_SubnetTree, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "SubnetTree_binary_lookup_mode" "', argument " "1"" of type '" "SubnetTree *""'"); 
  }
  arg1 = reinterpret_cast< SubnetTree * >(argp1);
  result = (bool)(arg1)->binary_lookup_mode();
...
fail:
  SWIG_SetErrorMsg(PyExc_NotImplementedError,"Wrong number of arguments for overloaded function 'SubnetTree_set_binary_lookup_mode'.\n"
    "  Possible C/C++ prototypes are:\n"
    "    set_binary_lookup_mode(SubnetTree *,bool)\n"
    "    set_binary_lookup_mode(SubnetTree *)\n");
  return NULL;
}
...
fail:
  SWIG_SetErrorMsg(PyExc_NotImplementedError,"Wrong number of arguments for overloaded function 'SubnetTree___contains__'.\n"
    "  Possible C/C++ prototypes are:\n"
    "    __contains__(SubnetTree *,char *,int)\n"
    "    __contains__(SubnetTree *,unsigned long)\n");
  return NULL;
}
...
static PyMethodDef SwigMethods[] = {
	 ...
	 { (char *)"SubnetTree_binary_lookup_mode", _wrap_SubnetTree_binary_lookup_mode, METH_VARARGS, NULL},
