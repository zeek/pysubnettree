...
SubnetTree::SubnetTree(bool binary_lookup_mode)
{
    tree = New_Patricia(128);
    _binary_lookup_mode = binary_lookup_mode;
}
...
// idk if we should be passing whole structs.  is it thread safe to pass
// pointers to function scope variables down the stack?
...
bool SubnetTree::binary_lookup_mode() {
    return _binary_lookup_mode;
}

void SubnetTree::set_binary_lookup_mode(bool binary_lookup_mode) {
    _binary_lookup_mode = binary_lookup_mode;
}
