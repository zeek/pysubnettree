...
testcase(not t1.binary_lookup_mode(), "Verify that binary lookup mode is not set")
...
testcase(t1.binary_lookup_mode(), "Switch to binary lookup mode")
...
testcase(not t1.binary_lookup_mode(), "Turn off binary lookup mode")
...
testcase(t2.binary_lookup_mode(), "Verify that binary lookup mode is set")
...
testcase(not t2.binary_lookup_mode(), "Turn off binary lookup mode")
